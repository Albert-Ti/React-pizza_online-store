...
export const sortListsValue = [
  ...
  { value: 'цене по возрастанию', type: 'price' },
...
function Sort() {
  ...
  React.useEffect(() => {
    ...
    return () => document.body.removeEventListener('click', handleClickOverlay)
  }, [])
  ...
  return (
    <div ref={sortRef} className='sort'>
      <div className='sort__label'>
        ...
        <b>Сортировка по:</b>
        <span onClick={() => setVisibleSort(!visibleSort)}>{sort.value}</span>
      </div>
      {visibleSort && (
        <div className='sort__popup'>
          <ul>
            {sortListsValue.map((obj, index) => (
              <li
                key={index}
